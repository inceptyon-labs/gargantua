...
enum LicenseErrorCopy {
    static func message(for error: PolarLicenseError) -> String {
        ...
        case .activationLimitReached:
            return "You've activated on the maximum of 3 Macs. Deactivate one on that Mac, "
                + "or use Manage Devices below to remove one you no longer have, then try again."
        case .notFound:
